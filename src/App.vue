<template>
  <div class="modal-shadow">
    <div class="modal">
      <div class="modal-header mb-4">
        <div>
          <h3 class="text-lg">Edit post title</h3>
        </div>
      </div>
      <div class="modal-body">
        <div>
          <div class=mb-4>
            <input type="text" placeholder="title" class="border border-gray-200 p-4 w-full">
          </div>
          <div class="mb-4">
            <textarea placeholder="content" class="border border-gray-200 p-4 w-full"></textarea>
          </div>
          <div>
  ...
  <div class="w-1/2 mx-auto p-4">
    ...
    <div>
      <div v-for="postItem in posts" class="p-4 mb-4 bg-white border border-gray-200 flex justify-between items-center">
          <div>
             <h3 class="text-lg text-gray-800 mb-2 border-b border-gray-200">{{ postItem.title }}</h3>
             <p class="text-gray-600 break-words whitespace-pre-line"></p>
            {{ postItem.content }}
          </div>
          <div class="flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 mr-2 text-emerald-600 cursor-pointer">
