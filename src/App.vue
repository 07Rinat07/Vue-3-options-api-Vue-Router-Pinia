  ...
  <div class="w-1/2 mx-auto p-4">
    ...
    <div>
      <div v-for="postItem in posts" class="p-4 mb-4 bg-white border border-gray-200 flex justify-between items-center">
          ...
          <div>
            <svg @click="deletePost(postItem)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 cursor-pointer">
